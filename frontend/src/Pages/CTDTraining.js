            ...
            <div style={{ width: "100%", height: 200 }}>
              <ResponsiveContainer>
                <PieChart>
                  ...
                  <Tooltip
                    content={(props) => (
                      <DonutTooltip {...props} total={total} />
                    )}
                  />
                </PieChart>
              </ResponsiveContainer>
          ...
          >
            ...
            >
              <div style={{ color: "#fff", fontWeight: 700, marginBottom: 8 }}>
                Top 5 users pending training (oldest)
              </div>
              <table
                style={{
                  width: "100%",
                ...
                <tbody>
                  {pendingUsers.slice(0, 5).map((u, i) => (
                    ...
                    >
                      ...
                      <td style={{ padding: "10px 6px", color: "#cfcfcf" }}>
                        {u.role}
                      </td>
                      <td style={{ padding: "10px 6px", color: "#cfcfcf" }}>
                        {u.pendingSince}
            ...
            >
              ...
              <div style={{ color: "#cfcfcf" }}>
                Total pending:{" "}
                <span style={{ color: "#ffb22b", fontWeight: 700 }}>120</span>
              </div>
              <div style={{ marginTop: 8, color: "#cfcfcf" }}>
                Longest pending:{" "}
                <span style={{ color: "#ffb22b", fontWeight: 700 }}>
                  2025-09-02
                </span>
              </div>
            </div>
...
const pendingUsers = [
  { name: "Capt. Nuwan Perera", role: "Manager", pendingSince: "2025-08-01" },
  {
    name: "Sgt. Malith Fernando",
    role: "Employee",
    pendingSince: "2025-08-15",
  },
  {
    name: "Cpl. Tharindu Jayasinghe",
    role: "Employee",
    pendingSince: "2025-08-20",
  },
  {
    name: "Lt. Col. Anura Senanayake",
    role: "Manager",
    pendingSince: "2025-08-25",
  },
  {
    name: "Pvt. Kavindu Rajapaksha",
    role: "Employee",
    pendingSince: "2025-09-02",
  },
  {
    name: "WO. Sivalingam Arulanantham",
    role: "Employee",
    pendingSince: "2025-09-10",
  },
];
