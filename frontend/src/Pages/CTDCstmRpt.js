      ...
      <div style={inner}>
        ...
        >
          ...
          >
            ...
            >
              {previewData.filter((p) => p.acknowledged === "No").length}
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              {new Set(previewData.map((p) => p.team)).size}
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={() => exportPDF("custom_report.pdf")}
            >
              PDF
            </button>
            <button
              style={{ ...btnPrimary, padding: "8px 14px" }}
              onClick={() => exportXLSX("custom_report.xlsx")}
            >
              Excel
            </button>
          </div>
